...
namespace QuanLiCoffeeCShapeDotNet.DTO
{
    public class Sqlcommands
    {
		...
		public static Sqlcommands Instances
		{
			get
			{
				if (instances == null) instances = new Sqlcommands();
				return Sqlcommands.instances;
			}

			set
			{
				Sqlcommands.instances = value;
			}
		}
        ...
        public Sqlcommands()
        {
            dataConnection.ConnectionString = @"Data Source=DESKTOP-HHQC8A8\KHANHLY;Initial Catalog=QL_COFFEE_CS414BIS_PDT;Integrated Security=True";
        }
        /// <summary>
        /// Procedure Open()
